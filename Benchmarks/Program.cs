...
namespace Benchmarks
{
    class Program
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            // BenchmarkRunner.Run < SerializeToString<Models.ThousandSmallClassList>>();
            //BenchmarkRunner.Run<DeserializeFromString<Models.SmallClass>>();
            //BenchmarkRunner.Run<DeserializeFromString<Models.BigClass>>();
           // BenchmarkRunner.Run<DeserializeFromString<Models.ThousandSmallClassList>>();
